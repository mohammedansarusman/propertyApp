...
const PropertDetails = ({property}) => {
  const { type, name, location, rates, beds, baths, square_feet, description } = property;
    ...
    return ( <main>
                  ...
                  <div className="flex flex-col md:flex-row justify-around">
                    <div className="flex items-center justify-center mb-4 border-b border-gray-200 md:border-b-0 pb-4 md:pb-0">
                      ...
                      <div className="text-2xl font-bold text-blue-500">
                        {rates.nightly ? (`$${rates.nightly.toLocaleString()}`) : (<FaTimes className="text-red-500"/>)}
                      </div>
                    </div>
                    <div className="flex items-center justify-center mb-4 border-b border-gray-200 md:border-b-0 pb-4 md:pb-0">
                      <div className="text-gray-500 mr-2 font-bold">Weekly</div>
                      <div className="text-2xl font-bold text-blue-500">
                        {rates.weekly ? (`$${rates.weekly.toLocaleString()}`) : (<FaTimes />)}
                      </div>
                    </div>
                    <div className="flex items-center justify-center mb-4 pb-4 md:pb-0">
                      <div className="text-gray-500 mr-2 font-bold">Monthly</div>
                      <div className="text-2xl font-bold text-blue-500">
                        {rates.monthly ? (`$${rates.monthly.toLocaleString()}`) : (<FaTimes className="text-red-500" />)}
                ...
                <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                  ...
                  <div className="flex justify-center gap-4 text-blue-500 mb-4 text-xl space-x-9">
                    ...
                    <p>{square_feet}
                      <span className="hidden sm:inline">Sq feet</span>
                    </p>
                  </div>
